...
<input type=button value="Login" onclick="javascript:login(document.all.user.value);"><br>
<input type=button value="Create Account" onclick="window.location.href='addAccount.php';">
</body>
</html>