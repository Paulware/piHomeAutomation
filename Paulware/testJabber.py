...
if __name__ == '__main__':
    ...
    #tojid=sys.argv[1]
    tojid='paulwarelistener@jix.im'
    
    source = 'Paulware@jabber.iitsp.com'	#change it to your own
    password = 'hello1'					#change it to your own
    target = 'paulwarelistener@jix.im'
